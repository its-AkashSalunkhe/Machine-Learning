...
# A Random Forest algorithm doesn't require Feature Scaling.
...
from sklearn.ensemble import RandomForestClassifier   # By default KNN Considers 5 Neighbours ( k = 5 )

#classifier = DecisionTreeClassifier()
classifier = RandomForestClassifier(n_estimators=35, random_state=0, max_depth=4)
...
# Test Case 1: Accuracy : 90%, Bias: 99% and Variance: 90%   (train_size = 0.20)
 
# Test Case 2: (n_estimators=35, random_state=0, max_depth=4) - Accuracy : 91%, Bias: 91% and Variance: 91%   (train_size = 0.20)
