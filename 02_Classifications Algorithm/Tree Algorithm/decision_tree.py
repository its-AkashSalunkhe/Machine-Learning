...
# A Decision Tree algorithm doesn't require Feature Scaling.
...
from sklearn.tree import DecisionTreeClassifier   # By default KNN Considers 5 Neighbours ( k = 5 )
...
# Test Case 1: Accuracy : 92%, Bias: 90% and Variance: 92%   (train_size = 0.20)
